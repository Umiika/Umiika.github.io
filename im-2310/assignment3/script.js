...
document.getElementById("tambourine").addEventListener("click", function(){
    document.getElementById("tambourineAudio").play();
});

document.getElementById("xylophone").addEventListener("click", function(){
    document.getElementById("xylophoneAudio").play();
});
