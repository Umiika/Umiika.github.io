...
function switchModes(){
  ...
  if (isDark){
    ...
    // I added the text symbol of "sun" and "moon" to represent as the symbol for light and dark mode. I think the symbols could help users understand more directly what this function is.
